          ...
          <div className="flex ">
            ...
            <div className="flex-1 w-64  text-center">
              <div className="relative overflow-x-auto  sm:rounded-lg">
                  ...
                  <tbody>
                    <tr className="odd:bg-white odd:dark:bg-sky-200 even:bg-gray-50 even:dark:bg-sky-800 border-b dark:border-gray-700">
                      ...
                      <td className="px-6 py-4">
                        <button className="rounded-lg px-2 py-2 text-white bg-green-500 mr-4 ">
                          เข้าพบ
                        </button>
                      </td>
                    </tr>
                    <tr className="odd:bg-white text-sky-100 odd:dark:bg-sky-200 even:bg-gray-50 even:dark:bg-sky-800 border-b dark:border-gray-700">
                      ...
                      <td className="px-6 py-4">$799</td>
                      <td className="px-6 py-4">
                       <button className="rounded-lg px-2 py-2 text-white bg-red-700 mr-4 ">
                          ไม่ได้เข้าพบ
                        </button>
                      </td>
                    </tr>
                    <tr className="odd:bg-white text-sky-700 odd:dark:bg-sky-200 even:bg-gray-50 even:dark:bg-sky-800 border-b dark:border-gray-700">
                      ...
                      <td className="px-6 py-4">
                      <button className="rounded-lg px-2 py-2 text-white bg-yellow-500 mr-4 ">
                          เข้าพบภายหลัง
                        </button>
                      </td>
                    </tr>
                ...
                <button className="rounded-lg text-center justify-center px-2 py-2 bg-green-500 mr-4 ">
                  เข้าพบ
                </button>
                <button className="rounded-lg text-center justify-center px-2 py-2 bg-red-700 mr-4 ">
                  ไม่ได้เข้าพบ
                </button>
                <button className="rounded-lg text-center justify-center px-2 py-2 bg-yellow-500 mr-4 ">
                  เข้าพบภายหลัง
                </button>
              </div>
            </div>
