          ...
          <div className="flex ">
            ...
            <div className="flex-1 w-64  text-center">
              <div className="relative overflow-x-auto  sm:rounded-lg">
                  ...
                  <tbody>
                    <tr className="odd:bg-white odd:dark:bg-sky-200 even:bg-gray-50 even:dark:bg-sky-800 border-b dark:border-gray-700">
                      ...
                      <td className="px-6 py-4">
                        <button className="rounded-lg px-2 py-2 text-white bg-sky-500 mr-4 ">
                          EDIT
                        </button>
                      </td>
                    </tr>
                ...
                <br />
                <button className="rounded-lg text-center  px-2 py-2 bg-sky-500 mr-4 ">
                  100 KM
                </button>
              </div>
            </div>
