            ...
            <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl  ring-2  lg:max-w-xl">
              ...
              <form className="mt-6">
                ...
                <div className="mb-2">
                  ...
                  <input
                    type="date"
                    className="block w-full px-4 py-2 mt-2 text-red-700 bg-white border rounded-md focus:border-indigo-400 focus:ring-indigo-300 focus:outline-none focus:ring focus:ring-opacity-40"
                  />
                </div>
                <div className="mb-2">
                  <label
